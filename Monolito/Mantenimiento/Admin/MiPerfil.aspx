<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MiPerfil.aspx.cs" Inherits="Monolito.Dashboard.MiPerfil" %>
<!DOCTYPE html>
<html lang="es">
<head runat="server">
    <meta charset="UTF-8">
    <title>NovaX | Mi Perfil Administrativo</title>
    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <div class="profile-card">
            <div class="header">
                ...
                <p style="opacity:0.5; font-size:11px; letter-spacing:1px; margin-top:8px;">NovaX Pro - Security & Identity Management</p>
            </div>
            ...
            <div class="profile-layout">
                <div class="photo-section">
                    ...
                    <p style="font-size:10px; opacity:0.5; margin-top:15px; line-height:1.5;">Procesamiento seguro en servidor.<br>Tama&ntilde;o m&aacute;ximo: 2MB.</p>
                </div>

                <div class="fields-grid">
                    <div class="input-group">
                        <label>C&eacute;dula / Identidad</label>
                    ...
                    <asp:Button ID="btnGuardar" runat="server" Text="GUARDAR EXPEDIENTE" CssClass="btn-save" OnClick="btnGuardar_Click" />
                </div>
            </div>
            ...
            <a href="DashboardAdmin.aspx" class="btn-back"><i class="fas fa-arrow-left"></i> VOLVER AL DASHBOARD PRINCIPAL</a>
        </div>
    </form>
    <script>
        function initSkulls() {
